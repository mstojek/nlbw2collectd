...
local PLUGIN_INSTANCE_RX = "uplink" -- change to "mangle-iptmon_rx" to have full compliance with iptmon
local PLUGIN_INSTANCE_TX = "downlink" -- change to "mangle-iptmon_tx" to have full compliance with iptmon
